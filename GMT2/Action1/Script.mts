...
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("increment quantity").Click
...
Browser("Advantage Shopping").Page("Advantage Shopping").Link("ShoppingCart").Highlight 
Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("remove product").Click @@ hightlight id_;_Browser("Advantage Shopping").Page("Advantage Shopping").WebElement("WebElement 2")_;_script infofile_;_ZIP::ssf5.xml_;_
